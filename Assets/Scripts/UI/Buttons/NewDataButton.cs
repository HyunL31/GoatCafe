...
public class NewDataButton : BaseButton
{
    [SerializeField] private Image Image_Background;

    public event Action OnButtonClicked;

    public bool SetButtonData(Sprite backgroundSprite, Sprite buttonSprite, string buttonText, TMP_FontAsset buttonFontAsset, Action buttonCallback)
    {
        ...
        if (DataCheck(backgroundSprite, buttonSprite, buttonText, buttonCallback) == false)
        {
            return false;
        }
    ...
    private bool DataCheck(Sprite backgroundSprite, Sprite buttonSprite, string buttonText, Action buttonCallback)
    {
        bool hasData = true;
